 ...
 */
define('GOOGLE_ANALYTICS_ID', 'UA-3517384-37'); // UA-XXXXX-Y (Note: Universal Analytics only, not Classic Analytics)
...
function roots_display_sidebar() {
  $sidebar_config = new Roots_Sidebar(
    ...
    array(
      'template-custom.php',
      'template-comotrabajamos.php',
      'template-quienessomos.php',
      'template-contacto.php',
      'template-home-productos.php'
    )
  );
